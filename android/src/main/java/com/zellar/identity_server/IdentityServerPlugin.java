package com.zellar.identity_server;
 ...
 */
public class IdentityServerPlugin implements MethodChannel.MethodCallHandler, PluginRegistry.ActivityResultListener {
    ...
    public static void registerWith(PluginRegistry.Registrar registrar) {
        ...
        channel.setMethodCallHandler(new IdentityServerPlugin(registrar));
    }
...
// fim
    ...
    private class PendingOperation {
        ...
        PendingOperation(String method, MethodChannel.Result result) {
            this.method = method;
            this.result = result;
        }
    }
